...
class LogisticsRecurringAgreement(models.Model):
    ...
    pickup_fsa_id = fields.Many2one("logistics.fsa", string="Pickup FSA [DEPRECATED]")
    delivery_fsa_id = fields.Many2one("logistics.fsa", string="Delivery FSA [DEPRECATED]")
    ...
    rate_per_shipment = fields.Float(string="Historical Rate [DEPRECATED]")
    currency_id = fields.Many2one("res.currency", default=lambda self: self.env.company.currency_id)
    next_shipment_date = fields.Date(string="Legacy Next Shipment [DEPRECATED]")
    route_run_id = fields.Many2one("logistics.route.run", string="Route Run [DEPRECATED]")
    departure_id = fields.Many2one("logistics.corridor.departure", string="Departure [DEPRECATED]")
