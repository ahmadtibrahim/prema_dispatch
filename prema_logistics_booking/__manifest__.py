{
    ...
    "category": "Logistics",
    "description": """
Prema Logistics Booking
=======================

Canonical commercial booking layer for Prema Dispatch. Service Routes and
Ordered Regions define network topology; PricingService, DepartureResolver and
CapacityEngine are the single authorities for price, exact departures and
physical capacity. Confirmed bookings produce one shipment identity, one
invoice, canonical physical pallets and physical dispatch operations.
""",
